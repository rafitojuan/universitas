...
if (isset($_POST['subSiswa'])) {
  if (addSiswa($_POST) > 0) {
    echo "
    <script>
    document.location.href = 'data-siswa?siswa=1';
    </script>";
  } else {
    echo "
    <script>
      document.location.href = 'data-siswa?fail';
    </script>";
  }
}
...
<body class="hold-transition sidebar-mini">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="../dosen/data-siswa" class="nav-link active">
          ...
          <div class="row">
            <div class="col-12">
              <a href="#" class="badge bg-success mb-2 p-2" data-toggle="modal" data-target="#modal-siswa">
                <i class="fas fa-user-plus"> Tambah Mahasiswa</i>
              </a>
              <?php
              if (isset($_GET['siswa'])) {
                echo '<div class="alert alert-warning alert-dismissible fade show" role="alert">
                <i class="  fas fa-check-circle"></i>
                <strong>Sukses!</strong> Data mahasiswa sudah ditambahkan.
              ...
              ';
                ...
                <i class="  fas fa-check-circle"></i>
                <strong>Oopss!</strong> Data mahasiswa gagal ditambahkan.
                <button type="button" id="dismissAlert" class="close" data-dismiss="alert" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              ';
                ...
                <i class="  fas fa-check-circle"></i>
                <strong>Sukses!</strong> Data mahasiswa berhasil diubah.
                <button type="button" id="dismissAlert" class="close" data-dismiss="alert" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              ';
                ...
                echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                <i class="  fas fa-check-circle"></i>
                <strong>Oopss!</strong> Data mahasiswa tidak diubah.
                <button type="button" id="dismissAlert" class="close" data-dismiss="alert" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title text-bold">Data Mahasiswa</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php foreach ($data_siswa as $items) : ?>
                        <tr>
                          <td><?= $items['NIM'] ?></td>
                          ...
                          <td class="text-center">
                            <a href="../function/updateSiswa?nim=<?= $items['nim']; ?>" class="uptSis badge bg-primary"><i class="fas fa-pencil-alt"></i> Update</a>
                          </td>
                          <td class="text-center">
                            <a href="../function/deleteSiswa?nim=<?= $items['nim']; ?> " class="delSis badge bg-danger"><i class="fas fa-trash"></i> Delete</a>
                          </td>
                        </tr>
                      <?php endforeach; ?>
                    </tbody>
          ...
          <form action="" method="post">
            <div class="modal-body">
              <div class="mb-3">
                ...
                <input type="text" name="namaSiswa" id="namaSiswa" class="form-control" required oninvalid="this.setCustomValidity('Kolom nama tidak boleh kosong!')" oninput="this.setCustomValidity('')">
              </div>
              <div class="mb-3">
                <label for="tingkat" class="form-label">Tingkat</label>
                <input type="number" name="tingkat" id="tingkat" min="1" max="10" class="form-control" required oninvalid="this.setCustomValidity('Isi tingkatan (1-10).')" oninput="this.setCustomValidity('')">
              </div>
              <div class="mb-3">
                <label for="password" class="form-label">Password</label>
                <input type="password" name="password" id="" class="form-control" required oninvalid="this.setCustomValidity('Kolom password harap diisi!')" oninput="this.setCustomValidity('')">
              </div>
              <div class="mb-3">
                <label for="alamat" class="form-label">Alamat</label>
                <textarea class="form-control" name="alamat" id="alamat" rows="3" required oninvalid="this.setCustomValidity('Harap isi alamat!')" oninput="this.setCustomValidity('')"></textarea>
              </div>
            </div>
            <div class="modal-footer justify-content-between">
              <button type="submit" class="btn btn-success" name="subSiswa"><i class="fas fa-paper-plane"></i> Input Data</button>
            </div>
          </form>
        </div>
        <!-- /.modal-content -->
  ...
  <script>
    $('.close').on('click', function() {
      window.location = 'data-siswa';
    })
  </script>

  <script>
    $('.uptSis').on('click', function(a) {
      a.preventDefault();
