...
if (isset($_POST['subMatkul'])) {
  if (addMatkul($_POST) > 0) {
    echo "
    <script>
    document.location.href = 'daftar-matkul.php?matkul=1';
    </script>";
  } else {
    echo "
    <script>
      document.location.href = 'daftar-matkul.php?fail';
    </script>";
  }
}
...
<body class="hold-transition sidebar-mini">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="daftar-matkul.php" class="nav-link active">
          ...
          <div class="row">
            <div class="col-12">
              <a href="#" class="badge bg-success mb-2 p-2" data-toggle="modal" data-target="#modal-siswa">
                <i class="fas fa-book"> Tambah Mata Kuliah</i>
              </a>
              <?php
              if (isset($_GET['matkul'])) {
                echo '<div class="alert alert-warning alert-dismissible fade show" role="alert">
                <i class="  fas fa-check-circle"></i>
                <strong>Sukses!</strong> Data mata kuliah berhasil ditambahkan.
              ...
              ';
                ...
                <i class="  fas fa-check-circle"></i>
                <strong>Oopps!</strong> Data mata kuliah tidak ditambahkan.
                <button type="button" id="dismissAlert" class="tutup close" data-dismiss="alert" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              ';
                ...
                <i class="  fas fa-check-circle"></i>
                <strong>Sukses!</strong> Data mata kuliah berhasil diubah.
                <button type="button" id="dismissAlert" class="tutup close" data-dismiss="alert" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              ';
                ...
                echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                <i class="  fas fa-check-circle"></i>
                <strong>Oopps!</strong> Data mata kuliah tidak diubah.
                <button type="button" id="dismissAlert" class="tutup close" data-dismiss="alert" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
                      ...
                      <?php foreach ($data_matkul as $items) : ?>
                        <tr>
                          ...
                          <td class="text-center">
                            <a href="../function/updateMatkul.php?matkul=<?= $items['id_matkul']; ?>" class="uptMatkul badge bg-primary"><i class="fas fa-pencil-alt"></i> Update</a>
                          </td>
                          <td class="text-center">
                            <a href="../function/deleteMatkul.php?matkul=<?= $items['id_matkul']; ?> " class="delMatkul badge bg-danger"><i class="fas fa-trash"></i> Delete</a>
                          </td>
                        </tr>
                      <?php endforeach; ?>
                    </tbody>
          ...
          <form action="" method="post">
            <div class="modal-body">
              ...
              <div class="mb-3">
                ...
                <input type="number" class="form-control" name="sks" id="sks" min="1" max="24" required oninvalid="this.setCustomValidity('Isi SKS (1-24).')" oninput="this.setCustomValidity('')">
              </div>
              <div class="mb-3">
            ...
            <div class="modal-footer justify-content-between">
              <button type="submit" class="btn btn-success" name="subMatkul"><i class="fas fa-paper-plane"></i> Input Data</button>
            </div>
          </form>
        </div>
        <!-- /.modal-content -->
  ...
  <script>
    $('.tutup').on('click', function() {
      window.location = 'daftar-matkul.php';
    })
  </script>
