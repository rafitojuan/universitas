...
if (isset($_POST['uptJadwal'])) {
  if (updateJadwal($_POST) > 0) {
    echo "
    <script>
    document.location.href = '../dosen/data-jadwal?update=1';
    </script>";
  } else {
    echo "
    <script>
      document.location.href = '../dosen/data-jadwal?notUpdate';
    </script>";
  }
}
...
<body class="hold-transition sidebar-mini">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="../dosen/data-jadwal" class="nav-link active">
  ...
  <script>
    $('.tutup').on('click', function() {
      window.location = '../dosen/data-jadwal';
    })
  </script>
