...
$getRuangan = query("SELECT * FROM ruangan WHERE id_ruangan = '$id_ruangan'")[0];
...
if (isset($_POST['uptRuangan'])) {
  if (updateRuangan($_POST) > 0) {
    echo "
    <script>
    document.location.href = '../dosen/daftar-ruangan.php?update=1';
    </script>";
  } else {
    echo "
    <script>
      document.location.href = '../dosen/daftar-ruangan.php?notUpdate';
    </script>";
  }
}
                ...
                <div class="card-body">
                  <form action="" method="post">
                    <div class="row mb-3">
                      ...
                      <div class="col-md-6">
                        <input type="text" name="idRuangan" class="form-control" id="idRuangan" required oninvalid="this.setCustomValidity('ID Ruangan harap di isi');" oninput="this.setCustomValidity('');" value="<?= $getRuangan['id_ruangan']; ?>">
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-3 mt-2">
                      ...
                      <div class="col-md-6">
                        <input type="text" name="namaRuangan" class="form-control" id="namaRuangan" required oninvalid="this.setCustomValidity('Nama ruangan harap di isi');" oninput="this.setCustomValidity('');" value="<?= $getRuangan['nama_ruangan']; ?>">
                      </div>
                    </div>
                </div>
                <!-- /.card-body -->
                <div class="card-footer justify-content-between text-right">
                  <button class="upt btn btn-success" name="uptRuangan"><i class="fas fa-upload"></i> Update</button>
                </div>
                </form>
              </div>
              <!-- /.card-body -->
