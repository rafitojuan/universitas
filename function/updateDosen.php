...
?>
    <script>
      window.location = '../dosen/data.php?update';
    </script>
<?php
  } else {
    echo "
    <script>
      document.location.href = '../dosen/data.php?notUpdate';
    </script>";
  }
}
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header bg-dark">
                  <h3 class="card-title text-bold">Update Data Dosen</h3>
                </div>

                <!-- /.card-header -->
                <div class="card-body">
                  <form action="" method="post">
                    <input type="hidden" name="id_dosen" value="<?= $getDosen['id_dosen']; ?>">
                    <div class="row">
                      <div class="col-md-3 mt-2">
                        <label for="nama_dosen" class="form-label">Nama Dosen :</label>
                      </div>
                      <div class="col-md-6">
                        <input type="text" name="namaDosen" class="form-control" id="nama_dosen" required oninvalid="this.setCustomValidity('Nama dosen harap di isi');" oninput="this.setCustomValidity('');" value="<?= $getDosen['nama_dosen']; ?>">
                      </div>
                    </div>
                </div>
                <!-- /.card-body -->
                <div class="card-footer justify-content-between text-right">
                  <button class="upt btn btn-success" name="uptDosen"><i class="fas fa-upload"></i> Update</button>
                </div>
                </form>
              </div>
              <!-- /.card -->
